    ...
    <>
      ...
      <section className="pt-32 pb-20 lg:pt-40 lg:pb-28">
        <div className="max-w-5xl mx-auto px-6 text-center">
          <ScrollReveal>
            <p className="font-playfair text-sm uppercase tracking-[0.3em] text-primary mb-6 bg-primary-foreground">
              Contact
            </p>
            <h1 className="font-cormorant text-5xl md:text-6xl lg:text-7xl leading-tight text-primary-foreground font-semibold">
              Begin the
              <br />
              <span className="text-primary-foreground">Conversation</span>
            </h1>
          </ScrollReveal>
        </div>
      </section>
